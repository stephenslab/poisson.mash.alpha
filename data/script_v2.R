...
scdata <- readRDS(paste0("data/scdata_rep", iter.idx, ".Rds"))
...
# saveRDS(fit.glmpca, file = paste0("output/fit_glmpca_rep", iter.idx, ".Rds"))
fit.glmpca <- readRDS(file = paste0("output/fit_glmpca_rep", iter.idx, ".Rds"))
Fuv <- as.matrix(fit.glmpca$loadings)
...
saveRDS(fit.ed, file = paste0("output/pois_mash_ruv_ed_rep", iter.idx, ".Rds"))
...
runtime = proc.time() - start_time
res[["runtime"]] = runtime
saveRDS(res, file = paste0("output/pois_mash_ruv_fit_rep", iter.idx, ".Rds"))
