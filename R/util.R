# This file contains utility functions to update model and variational
# parameters and speed up matrix inversions. These are internal
# functions which users might not want to call directly.

# Function to update q(theta) = q(eta) for a given unit without fixed
# effects, i.e., with prior covariance U = 0.
