...
$R$ conditions ($R$ should be considerably larger than 2). he original
neutrophils dataset contained counts for 13,362 cells, 8,543 genes and
45 conditions (44 cytokine treatments plus one control). For the
purposes of this vignette, we use a small subset of these data (1,936
cells, 2,158 genes, 12 conditions).
...
```{r calculate-size-factor, message=FALSE, eval=FALSE}
...
```{r create-data-object, eval=FALSE}
...
```{r ruv, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r canonical, message=FALSE, eval=FALSE}
