...
covariance matrices using the Extreme Eeconvolution (ED) algorithm, and is
...
this illustration, we only run `pois_mash` for 5 iterations, but we
ini practice recommend setting `maxiter = 100` (or more) when
